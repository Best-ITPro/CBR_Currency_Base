...
// Cbr
Vue.component('chartcbrline-component', require('./components/ChartcbrlineComponent').default);
Vue.component('chartcbrinfo-component', require('./components/ChartcbrinfoComponent').default);
